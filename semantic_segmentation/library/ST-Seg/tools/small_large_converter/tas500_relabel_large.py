...
# 1 -- rough : gravel, soil, asphalt
# 2 -- soft_veg : low_grass, high_grass
# 3 -- hard_veg : bush, forest, tree_crown, tree_trunk,
# 4 -- puddle : 
# 5 -- obstacle :  building, fence, wall, misc_object, pole, traffic_sign, car, bus, person, animal, sand, 

# 0 -- Background           misc.veg, sky, ego_vehicle, undefined
# 1 -- smooth_ground        asphalt
# 2 -- rough_ground         soil
# 3 -- bumpy_ground         gravel
# 4 -- soft_veg             low_grass, high_grass
# 5 -- hard_veg             bush, forest, tree_crown, tree_trunk
# 6 -- puddle :             
# 7 -- obstacle             sand, building, fence, wall, car, bus, misc.object, pole, traffic_sign
#                           person, animal
...
with open(osp.join(data_dir, 'train.txt'), 'r') as r:
    ...
    for l in r:
        ...
        mmcv.imwrite(out2, data_dir + save_folder + l.strip() + "_large.png")
        mmcv.imwrite(out2, additional_save_folder + l.strip() + "_large.png")
