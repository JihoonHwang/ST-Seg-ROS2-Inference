...
# 2 -- rough ground         dirt, sand, mulch
# 3 -- bumpy ground         gravel, rock-bed
# 4 -- soft_veg:            grass 
# 5 -- hard_veg:            bush, tree
# 6 -- puddle:              water
# 7 -- obstacle:            log, rock, person, vehicle, bicycle, pole, container/generic-object, building, sign, fence, 
#                           picnic-table, bridge
