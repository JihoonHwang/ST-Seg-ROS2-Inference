...
Groups = [0, 5, 4, 1, 7, 0, 2, 6, 5]

# 0 -- background:          background, sky   
# 1 -- smooth_ground        smooth_trail    
# 2 -- rough ground         rough_trail
# 3 -- bumpy ground
# 4 -- soft_veg             traversable_grass
# 5 -- hard_veg             non_traversable_low_vegetation, high_vegetation
# 6 -- puddle:              puddle
# 7 -- obstacle             obstacle 
#                           
