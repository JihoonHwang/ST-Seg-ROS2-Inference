...
class RUGD_Hanhwa_Dataset_Group9(CustomDataset):
    """RUGD dataset.
    ...
    PALETTE = [[ 0, 0, 0 ], [ 64,64,64 ],[ 255, 128, 0 ],[153,204,255],[ 0, 255, 0 ], [0,150,0], [0,50,0],
            [ 0, 0, 255 ],[  255, 0, 127] ]


    def __init__(self, **kwargs):
        super(RUGD_Hanhwa_Dataset_Group9, self).__init__(
            img_suffix='.png',
        ...
        self.PALETTE = [[ 0, 0, 0 ], [ 64,64,64 ],[ 255, 128, 0 ],[153,204,255],[ 0, 255, 0 ], [0,150,0], [0,50,0],
            [ 0, 0, 255 ],[  255, 0, 127] ]
