...
class Attention(nn.Module):
    def __init__(
        ...
        *,
        ...
        if size_index != None:
            dim = dim[size_index]
        dim_head = int(dim / heads) # 384 / 6 = 64, 384 / 8 = 48, 376/7 = 
        self.scale = dim_head ** -0.5 # 8
        inner_dim = heads * dim_head # 48
        self.dim_head = dim_head # 64
        self.to_qkv = nn.Conv2d(dim, inner_dim * 3, 1, bias = False) # 64, 144, 1 conv
        print(fmap_size)
        self.h = fmap_size[0]
        self.w = fmap_size[1]
    ...
    def forward(self, fmap):
        ...
        # 8, 8, 384, 38, 47
        #print(b,c,h,w)
        #heads, b, c, w, h = self.heads, *fmap.shape
        # print()
        # print(h) # 38
        # print(w) # 47
