...
class EncoderDecoder(BaseSegmentor):
    ...
    def encode_decode(self, img, img_metas):
        ...
        out, latent = self._decode_head_forward_test(x, img_metas)
        # print(img_metas)
        # print(out.shape)
        # print(out)#####################################################################################
        # fefe
    ...
    def _decode_head_forward_train(self,
        ...
        training."""
        losses = dict()
        loss_decode, _ = self.decode_head.forward_train(x, img_metas,
                                                     gt_semantic_seg,
                                                     self.train_cfg,
                                                     seg_weight)
    ...
    def _decode_head_forward_test(self, x, img_metas):
        ...
        return seg_logits[0], seg_logits[1]
    ...
    def forward_train(self,
        ...
        x = self.extract_feat(img)  ## mit output feature 4 multiscale feat
        losses = dict()
        if return_feat:
            losses['features'] = x
    ...
    def whole_inference(self, img, img_meta, rescale):
        ...
        seg_logit, logit = self.encode_decode(img, img_meta)
    ...
    def inference(self, img, img_meta, rescale):
        ...
        if self.test_cfg.mode == 'slide':
            ...
            seg_logit, logit = self.whole_inference(img, img_meta, rescale)
    ...
    def simple_test(self, img, img_meta, rescale=True):
        ...
        seg_logit, logit = self.inference(img, img_meta, rescale)
        # print("seglogit", seg_logit.shape)
